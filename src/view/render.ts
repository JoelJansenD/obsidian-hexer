...
export default function render(
    ...
    // own display size for the on-screen editor; the print path passes an explicit
    // viewport so it can frame a tight crop against an offscreen canvas that has no
    // layout size of its own.
...
// Exported so the print path can compute a tight crop from the same corner
// geometry the renderer draws, rather than a looser centre-plus-circumradius box.
