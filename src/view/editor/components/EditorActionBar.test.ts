...
const createActionBar = () => {
    ...
    const bar = new EditorActionBar(parent, { onZoomToFit, onToggleMode });
    return { bar, parent, onZoomToFit, onToggleMode };
};
...
describe('EditorActionBar', () => {
    it('renders the mode toggle and zoom-to-fit buttons', () => {
        // Act
