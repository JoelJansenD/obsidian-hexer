import { getArea, getNeighbours, Hexagon, hexagonIsEmpty, pointToAxialCoordinates, AxialCoordinates, axialCoordinatesToPoint, roundAxialCoordinates } from "./hexagon";
...
describe('pointToAxialCoordinates', () => {
    it.for([
        ...
        // Act
        const result = pointToAxialCoordinates(x, y, size, 'flat-top');
...
describe('axialCoordinatesToPoint', () => {
    it.for([
        ...
        // Act
        const result = axialCoordinatesToPoint({ q, r }, size, 'flat-top');
    ...
    it('scales after converting', () => {
        ...
        // Act
        const result = axialCoordinatesToPoint({ q: 0, r: 10 }, size, 'flat-top');
